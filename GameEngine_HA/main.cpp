...
// Scale the object
			...
			if (pCurrentMeshObject->hasPhysicsObject)
			{
				pCurrentMeshObject->position = pCurrentMeshObject->physics_object->GetPosition();
				pCurrentMeshObject->position += glm::vec3(5, 0, 0);
				pCurrentMeshObject->physics_object->scale = pCurrentMeshObject->scale;
			}
